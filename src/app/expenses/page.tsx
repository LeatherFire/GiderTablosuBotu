      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600">Tüm gider kayıtları</p>
          </div>
          <Link
            href="/add"
          ...
          <div className="bg-white rounded-xl shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-xl font-bold text-gray-800">Gider Detayı</h2>
                <button
                ...
                <div className="bg-blue-50 rounded-lg p-4">
                  <div className="flex justify-between items-start">
                    <div>
                      ...
                      <p className="text-3xl font-bold text-blue-700">{formatCurrency(selectedExpense.amount)}</p>
                  ...
                  <div className="bg-gray-50 rounded-lg p-4 space-y-2">
                    ...
                    {selectedExpense.recipientIban && (
                      <div className="flex justify-between">
                        ...
                        <span className="font-mono text-sm">{selectedExpense.recipientIban}</span>
                      </div>
                    )}
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="bg-gray-50 rounded-lg p-4 space-y-2">
                    ...
                    {selectedExpense.senderIban && (
                      <div className="flex justify-between">
                        <span className="text-gray-600">IBAN:</span>
                        <span className="font-mono text-sm">{selectedExpense.senderIban}</span>
                      </div>
                    )}
                  </div>
                </div>
                  ...
                  <div className="bg-gray-50 rounded-lg p-4 space-y-2">
                    ...
                    {selectedExpense.transactionId && (
                      <div className="flex justify-between">
                        ...
                        <span className="font-mono text-sm">{selectedExpense.transactionId}</span>
                      </div>
                    )}
        ...
        <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl shadow-xl max-w-4xl w-full max-h-[95vh] overflow-hidden flex flex-col">
            <div className="p-4 border-b flex items-center justify-between">
              <h2 className="text-lg font-bold text-gray-800">Dekont</h2>
